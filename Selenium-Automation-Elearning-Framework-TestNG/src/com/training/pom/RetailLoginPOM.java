...
public class RetailLoginPOM {
	...
	@FindBy(xpath= "//div[contains(text(), ' Warning: No match for E-Mail Address and/or Password')]") private WebElement invalidLoginmsg;
...
//	public void loginFailureMessage(String exploginmsg) {
